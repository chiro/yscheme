...
(define-predicate scm-bytevector? ((obj scm-vector)) +false+ +true+)
...
(defgeneric scm-utf8->string (obj))
(defmethod scm-utf8->string ((bytevec scm-bytevector))
  (new 'scm-string :val (sb-ext:octets-to-string (val bytevec))))

(defgeneric scm-string->utf8 (obj))
(defmethod scm-string->utf8 ((str scm-string))
  (new 'scm-bytevec :val (sb-ext:string-to-octets (val str))))